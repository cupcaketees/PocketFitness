...
public class BodybuildingShouldersActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        workouts.add(new Workout("Dumbbell Shoulder Press", "Instructions: \n" + "Standing holding a dumbbell in each hand at shoulder height, palms facing forward. One at a time, raise each arm to push the weight up until it is fully extended. Lower to the start position and repeat. Keep your core tensed throughout.", "http://www.makeoverfitness.com/images/seated-dumbbell-press.gif", "Difficulty: Easy"));

        workouts.add(new Workout("Dumbbell Lateral Raise", "Instructions: \n" + "Stand holding a pair of dumbbells at your sides with an overhand grip, your elbows slightly bent. Raise your arms up and out to the side until they're parallel to the floor, keeping the same bend in your elbows. Pause, then slowly return to the starting position.",  "http://www.makeoverfitness.com/images/dumbbell-lateral-raise.gif", "Difficulty: Easy"));

        workouts.add(new Workout("Seated Barbell Military Press", "Instructions: \n" + "Grab a barbell with a full, overhand grip that's shoulder width or a little wider. Press the bar overhead until your arms are straight but not locked. Slowly return to the starting position.",  "http://www.makeoverfitness.com/images/barbell-military-press.gif", "Difficulty: Medium"));

        workouts.add(new Workout("Barbell Upright Row", "Instructions: \n" + "Grab a barbell with a false, overhand grip that's shoulder width or a little wider Stand and let the bar hang at arm's length in front of your thighs. Pull the bar up to your lower chest, or until your upper arms are parallel to the floor. Pause, then slowly return to the starting position.", "http://www.makeoverfitness.com/images/upright-row-barbell.gif", "Difficulty: Easy"));
