...
public class NewsActivity extends NavigationBarActivity {
    ...
    @Override
    public void setup() {
        stub.setLayoutResource(R.layout.news_list_view);
        stub.inflate();
        ...
        newsArticles.add(new NewsArticle("New superfood", "Golden berries, these are deliciously sweet options are solid sources of fiber, plus they’re rich in antioxidants and heart-healthy fatty acids. ", R.drawable.temp_man_running, "24/01/2019"));
